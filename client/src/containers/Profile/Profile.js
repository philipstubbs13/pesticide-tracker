      ...
      <div className={classes.signupContainer}>
        <Paper className={classes.root} elevation={1}>
          ...
          <div className={classes.pictureContainer}>
            <AvatarEditor
              image src = "https://upload.wikimedia.org/wikipedia/commons/7/7e/Circle-icons-profile.svg"
              width={500}
              height={500}
              border={500}
              rotate={0}
        ...
        <div className={classes.historyContainer}>
          <Paper className={classes.root} elevation={1}>
            <Typography variant="h4">
              ...
              <div className={classes.historyContainer}>
              <Button className = {classes.seeHistoryBtn} fullWidth variant="contained" color="primary" onClick={this.handleSubmit}>
                        Year One Report
              </Button>
              <Button className = {classes.seeHistoryBtn} fullWidth variant="contained" color="primary" onClick={this.handleSubmit}>
                        Year Two Report
